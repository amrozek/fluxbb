...
$author         = 'amrozek';
$author_email   = 'wagner.a.r@gmail.com';
...
function install()
{
	...
	$db->add_field('users', 'gender', 'INT(1)', FALSE, '0') or error('Unable to add column "gender" to table "users"', __FILE__, __LINE__, $db->error());
	$db->add_field('users', 'gender_enabled', 'INT(1)', FALSE, '0') or error('Unable to add column "gender_enabled" to table "users"', __FILE__, __LINE__, $db->error());
...
function restore()
{
	...
	$db->drop_field('users', 'gender') or error('Unable to drop column "gender" from table "users"', __FILE__, __LINE__, $db->error());
	$db->drop_field('users', 'gender_enabled') or error('Unable to drop column "gender_enabled" from table "users"', __FILE__, __LINE__, $db->error());
