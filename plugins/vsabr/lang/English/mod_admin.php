...
<em>Option</em>: The question will also be asked for the messages sent by guests, if they are allowed to post. To delete this option, edit the file search_insert.php <strong>before</strong> installing with indications noted in this file.',
);
?>